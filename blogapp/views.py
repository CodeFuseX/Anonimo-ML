...
from home.models import editProfile,FriendRequest, FollowersCount,Doctor
...
def anonymhome(request):
    ...
    if request.user.is_authenticated:
        ...
        context = {'allPosts': allPosts, 'allProfiles':allProfiles, 'allBadges':allBadges,'friend_count':friend_count, 'allfollowers':allfollowers,'friendlist':friendlist,'profileCheck':profileCheck,'doc_present':doc_present,'mental_count':mental_count,'approved':approved}
        return render(request, 'anonym.html', context)
    else:
        context = {'allPosts': allPosts, 'allProfiles':allProfiles, 'allBadges':allBadges,'friend_count':friend_count,'doc_present':doc_present}
        return render(request, 'anonym.html', context)
